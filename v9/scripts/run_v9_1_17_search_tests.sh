...
RUN_ID="v9.1.17-search-${RUN_TS}"
OUT_DIR="v9/artifacts/runs/${RUN_ID}"
mkdir -p "$OUT_DIR"

LOG_FILE="$OUT_DIR/test-log-v9.1.17-search.txt"
...
summary_lines.extend([
    '',
    '## Artifacts',
    f'- `{out / "test-log-v9.1.17-search.txt"}`',
