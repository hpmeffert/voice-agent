## Highlights
- Performance logging can now be switched on and off at runtime from Admin settings.
...
- Voice-path proof in the automated script is still marked `SKIP` unless a deterministic audio sample is supplied.
