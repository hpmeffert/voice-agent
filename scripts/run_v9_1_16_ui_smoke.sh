...
RUN_ID="v9.1.16-ui-smoke-${TS}"
OUT_DIR="v9/artifacts/runs/${RUN_ID}"
mkdir -p "$OUT_DIR"
LOG_FILE="$OUT_DIR/test-log-v9.1.16-ui-smoke.txt"
...
- bash scripts/run_v9_1_16_ui_smoke.sh
